...
<head>
    ...
    <script> 
        function calcFibo () {
            ...
            nextTerm;
            clearInput();
            // console.clear(); - to clear console if user spams click on calculating fibonacci
        ...
        // clear input text on fibo
        function clearInput(){
            document.getElementById("output").innerHTML = "";
        }
        // check quarantine if your my minion
...
<body>
    ...
    <input type="number" id="limit" onkeydown="return event.keyCode !== 69" />
    ...
    <input type="number" id="age" onkeydown="return event.keyCode !== 69" />
    <button onclick="checkQuarantine()">calculate range</button>
    <div id="output_age"></div>
    <div id="demo"></div>

    <!-- Remove value from input text ~ will comment out:)-->
    <!-- <script>
        $(document).ready(function(){
            $('#btnCalcFibo').click(function(){		
                    $('#limit').val('');
            });
        });
    </script> -->
